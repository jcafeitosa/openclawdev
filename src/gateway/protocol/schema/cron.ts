...
export const CronDeliverySchema = z
  .object({
...
export const CronDeliveryPatchSchema = z
  .object({
...
export const CronAddParamsSchema = z
  .object({
    name: NonEmptyString,
    agentId: z.union([NonEmptyString, z.null()]).optional(),
    description: z.string().optional(),
...
export const CronJobPatchSchema = z
  .object({
    ...
    delivery: CronDeliveryPatchSchema.optional(),
